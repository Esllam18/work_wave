...
class _NotificationsViewState extends State<NotificationsView> {
  ...
  final List<NotificationModel> notificationsForApplications = [
    // 🔵 Applications
    NotificationModel(
      textSpan: 'Your application is submitted successfully to BMW. ',
      orginalText: 'You can check the status here.',
      image: AppImages.bmw,
      time: '1 hr ago',
      isRead: true,
    ),
  ...
  final List<NotificationModel> notificationsForInterview = [
    // 🔴 Interview
    NotificationModel(
      textSpan: 'Congratulations! Beats ',
    ...
    NotificationModel(
      textSpan: 'Congratulations! You passed the first round on Behance. ',
      orginalText: 'Be prepare for next!',
